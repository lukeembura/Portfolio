...
about = {
    "name": "Luke Rono",
    "bio": "I am currently a Full Stack Developer studying at Moringa School. I'm a passionate developer with a love for both technology and aviation. I specialize in building modern web applications using Python, Flask, React, and HTML/CSS. My goal is to bridge the gap between code and cockpit—creating tools that enhance aviation safety, efficiency, and innovation.",
